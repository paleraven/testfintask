...
public class Balance {
     ...
     */
    @AssertTrue
    public boolean rule1110() {
        return this.row1110.signum() > 0 || this.row1100 == null;
    }

    @AssertTrue
    public boolean rule1120() {
        return this.row1120.signum() > 0 || this.row1120 == null;
    }

    @AssertTrue
    public boolean rule1130() {
        return this.row1130.signum() > 0 || this.row1130 == null;
    }

    @AssertTrue
    public boolean rule1140() {
        return this.row1140.signum() > 0 || this.row1140 == null;
    }

    @AssertTrue
    public boolean rule1150() {
        return this.row1150.signum() > 0 || this.row1150 == null;
    }

    @AssertTrue
    public boolean rule1160() {
        return this.row1160.signum() > 0 || this.row1160 == null;
    }

    @AssertTrue
    public boolean rule1170() {
        return this.row1170.signum() > 0 || this.row1170 == null;
    }

    @AssertTrue
    public boolean rule1190() {
        return this.row1190.signum() > 0 || this.row1190 == null;
    }

    @AssertTrue
    public boolean rule1200() {
        return this.row1200.signum() > 0 || this.row1200 == null;
    }

    @AssertTrue
    public boolean rule1210() {
        return this.row1210.signum() > 0 || this.row1210 == null;
    }

    @AssertTrue
    public boolean rule1220() {
        return this.row1220.signum() > 0 || this.row1220 == null;
    }
    @AssertTrue
    public boolean rule1230() {
        return this.row1230.signum() > 0 || this.row1230 == null;
    }
    @AssertTrue
    public boolean rule1240() {
        return this.row1240.signum() > 0 || this.row1240 == null;
    }
    @AssertTrue
    public boolean rule1250() {
        return this.row1250.signum() > 0 || this.row1250 == null;
    }
    @AssertTrue
    public boolean rule1260() {
        return this.row1260.signum() > 0 || this.row1260 == null;
    }

    @AssertTrue
    public boolean rule1310() {
        return this.row1310.signum() > 0 || this.row1310 == null;
    }

    @AssertTrue
    public boolean rule1340() {
        return this.row1340.signum() > 0 || this.row1340 == null;
    }

    @AssertTrue
    public boolean rule1350() {
        return this.row1350.signum() > 0 || this.row1350 == null;
    }

    @AssertTrue
    public boolean rule1360() {
        return this.row1360.signum() > 0 || this.row1360 == null;
    }


    @AssertTrue
    public boolean rule1400() {
        return this.row1400.signum() > 0 || this.row1400 == null;
    }

    @AssertTrue
    public boolean rule1410() {
        return this.row1410.signum() > 0 || this.row1410 == null;
    }

    @AssertTrue
    public boolean rule1430() {
        return this.row1430.signum() > 0 || this.row1430 == null;
    }

    @AssertTrue
    public boolean rule1450() {
        return this.row1450.signum() > 0 || this.row1450 == null;
    }

    @AssertTrue
    public boolean rule1500() {
        return this.row1500.signum() > 0 || this.row1500 == null;
    }

    @AssertTrue
    public boolean rule1510() {
        return this.row1510.signum() > 0 || this.row1510 == null;
    }

    @AssertTrue
    public boolean rule1520() {
        return this.row1520.signum() > 0 || this.row1520 == null;
    }
    @AssertTrue
    public boolean rule1530() {
        return this.row1530.signum() > 0 || this.row1530 == null;
    }
    @AssertTrue
    public boolean rule1540() {
        return this.row1540.signum() > 0 || this.row1540 == null;
    }
    @AssertTrue
    public boolean rule1550() {
        return this.row1550.signum() > 0 || this.row1550 == null;
    }

    @AssertTrue
    public boolean rule1600() {
        return this.row1600.signum() > 0 || this.row1600 == null;
    }

    @AssertTrue
    public boolean rule1700() {
        return this.row1700.signum() > 0 || this.row1700 == null;
    }
