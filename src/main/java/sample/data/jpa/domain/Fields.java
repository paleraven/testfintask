...
public class Fields {
    ...
    BigDecimal row1110, row1120, row1130, row1140, row1150, row1160, row1170, row1180, row1190, row1100,
            row1210, row1220, row1230, row1240, row1250, row1260, row1200,
            row1310, row1320, row1330, row1340, row1350, row1360, row1370, row1300,
            row1410, row1420, row1430, row1440, row1450, row1400,
            row1510, row1520, row1530, row1540, row1550, row1500,
            row1600;
    ...
    public BigDecimal getRow1330() {
        return row1330;
    }

    public void setRow1330(BigDecimal row1330) {
        this.row1330 = row1330;
    }
    ...
    public BigDecimal getRow1440() {
        return row1440;
    }

    public void setRow1440(BigDecimal row1440) {
        this.row1440 = row1440;
    }
